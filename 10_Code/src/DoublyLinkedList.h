...
class DLX{
    ...
    //  This method returns the sudoku solution
    const std::vector<std::vector<int>>& getSolution() const;

    //  This method checks whether the puzzle has a valid solution
    bool hasSolution() const;

    //  This method checks whether the puzzle is underdefined (has multiple solutions)
    bool hasMultipleSolutions() const;
    ...
    int solutionSpace;
    //  Owns every dynamically allocated DLX node.
    std::vector<DLXNode*> allocatedNodes;
